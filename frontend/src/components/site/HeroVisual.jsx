 ...
 const cards = [
  ...
  return (
    <div className="relative w-full aspect-square max-w-[560px] mx-auto" data-testid="hero-visual">
      ...
      >
        <div className="absolute -top-1.5 left-1/2 -translate-x-1/2 h-3 w-3 rounded-full bg-blue-500 shadow-[0_0_20px_6px_rgba(249,115,22,0.55)]" />
        <div className="absolute top-1/2 -right-1.5 -translate-y-1/2 h-2.5 w-2.5 rounded-full bg-blue-500 shadow-[0_0_20px_6px_rgba(59,130,246,0.55)]" />
      ...
      >
        <motion.div
          ...
          className="relative h-44 w-44 sm:h-52 sm:w-52 rounded-full bg-gradient-to-br from-slate-900 via-slate-800 to-slate-950 grid place-items-center shadow-2xl shadow-slate-900/15"
        >
          {/* Inner glow */}
        ...
        >
          <div className="bg-white/90 backdrop-blur-xl border border-white shadow-xl shadow-slate-900/10 rounded-2xl p-3 sm:p-4 flex items-center gap-2.5 sm:gap-3">
            ...
            <div className="leading-tight">
              <div className="font-bold text-slate-900 text-[12px] sm:text-[13.5px]">{c.label}</div>

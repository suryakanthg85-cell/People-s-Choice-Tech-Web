    ...
    <div>
      <section className="relative pt-20 pb-16 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 relative">
          <div className="text-[11px] uppercase tracking-[0.24em] text-orange-600 font-bold eyebrow-line">Services</div>
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="bg-slate-950 rounded-3xl p-10 lg:p-14 text-white text-center">
            <h2 className="text-3xl lg:text-4xl font-black tracking-tight">Not sure which service fits?</h2>

    ...
    <div>
      <section className="relative pt-20 pb-16 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 relative">
          <div className="text-[11px] uppercase tracking-[0.24em] text-blue-600 font-bold eyebrow-line">Technologies</div>
          ...
          {Object.entries(TECH_STACK).map(([cat, items]) => (
            <div key={cat} className={`bg-gradient-to-br ${CATEGORY_COLORS[cat] || "from-slate-50 to-white"} border border-slate-200 rounded-2xl p-7`} data-testid={`tech-cat-${cat.toLowerCase()}`}>
              <div className="flex items-center justify-between flex-wrap gap-3">
                <div>
                  <div className="text-[11px] uppercase tracking-[0.18em] text-blue-600 font-bold">Stack</div>
                  <h2 className="text-2xl lg:text-3xl font-bold tracking-[-0.005em] text-slate-900 mt-1">{cat}</h2>
                </div>
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="bg-slate-950 rounded-3xl p-10 lg:p-14 text-white text-center">
            <h2 className="text-3xl lg:text-4xl font-bold tracking-[-0.005em]">Need a specific stack expert?</h2>

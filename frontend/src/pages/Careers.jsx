    ...
    <div>
      <section className="relative pt-20 pb-16 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 relative">
          <div className="text-[11px] uppercase tracking-[0.24em] text-orange-600 font-bold eyebrow-line">Careers</div>
      ...
      <section className="py-14 border-y border-slate-200 bg-slate-50/60">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <h2 className="text-3xl lg:text-4xl font-black tracking-tight text-slate-900">Open positions</h2>
      ...
      <section className="py-16">
        <div className="max-w-3xl mx-auto px-6 lg:px-8 text-center">
          <h2 className="text-4xl font-black tracking-tight text-slate-900">Don't see your role?</h2>

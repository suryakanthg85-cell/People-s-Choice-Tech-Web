  ...
  return (
    <div className="relative min-h-[70vh] grid place-items-center overflow-hidden">
      ...
      <div className="text-center px-6 relative">
        <div className="text-[11px] uppercase tracking-[0.24em] text-blue-600 font-bold">404</div>
        <h1 className="mt-4 text-5xl lg:text-7xl font-bold tracking-[-0.005em] text-slate-900">Lost in space.</h1>
